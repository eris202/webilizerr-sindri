    ...
    if (reportId) {
        axios
            ...
            if (response.data.success) {
                ...
                var overallGrade = Math.round((performanceGrade +
                    seoGrade +
                    uiGrade +
                    securityGrade +
                    socialGrade) /
                ...
                if (jsonn.malware.data.avg == "unverified" ||
                ...
                // Change byte to mb
                jsonn.pageSize.data.mbSize = formatBytes(jsonn.pageSize.data.totalSize);
...
//# sourceMappingURL=willBeRemovedReportController.js.map