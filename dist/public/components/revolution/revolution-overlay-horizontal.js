let tpj = jQuery, revSelector = '#rev_slider_overlay_horizontal';
tpj(document).ready(function () {
    if (tpj(revSelector).revolution == undefined) {
        ...
        let defaults = {
            ...
            fullScreenOffsetContainer: '#header-overlay-horizontal',
            minHeight: '260',
            gridwidth: 1280,
            stopLoop: 'off',
            stopAfterLoops: -1,
...
//# sourceMappingURL=revolution-overlay-horizontal.js.map