let tpj = jQuery, revSelector = '#rev_slider_slide_horizontal';
tpj(document).ready(function () {
    if (tpj(revSelector).revolution == undefined) {
        ...
        let defaults = {
            ...
            fullScreenOffsetContainer: '#header-slide-horizontal',
            minHeight: '260',
            gridwidth: 1280,
            stopLoop: 'off',
            stopAfterLoops: -1,
...
//# sourceMappingURL=revolution-slide-horizontal.js.map