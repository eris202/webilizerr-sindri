let tpj = jQuery, revSelector = '#rev_slider_28_1', revapiParallaxZoomSlices;
tpj(document).ready(function () {
    ...
    if (revapiParallaxZoomSlices)
        revapiParallaxZoomSlices.revSliderSlicey();
}).on('revolution.slide.onloaded', function () {
    document.querySelector(revSelector).parentElement.classList.add('loaded');
});
//# sourceMappingURL=revolution-parallax-zoom-slices.js.map