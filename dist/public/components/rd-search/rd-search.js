...
RDSearch.defaults = {
    ...
    filter: '*.html',
    template: `<h5 class="search-title"><a target="_top" href="#{href}" class="search-link">#{title}</a></h5>
		<p>...#{token}...</p>
...
RDSearch.prototype.getResult = function (params) {
    ...
    let xhr = new XMLHttpRequest(), req = new URLSearchParams(params);
...
//# sourceMappingURL=rd-search.js.map