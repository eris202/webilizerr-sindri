...
function initHighchartsDouble(data) {
    let node = this, detailChart;
    // create the detail chart
    function createDetail(masterChart) {
        // prepare the detail chart
        var detailData = [], detailStart = data[0][0];
        ...
        detailChart = Highcharts.chart(node.querySelector('[data-highcharts-double="detail"]'), {
            chart: {
                type: 'spline',
                reflow: true,
                marginTop: 25,
    ...
    function createMaster() {
        Highcharts.chart(node.querySelector('[data-highcharts-double="master"]'), {
            chart: {
                reflow: true,
                marginLeft: 0,
                marginRight: 0,
...
//# sourceMappingURL=highchart-double.init.js.map