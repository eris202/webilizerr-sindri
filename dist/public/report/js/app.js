window.Element && !Element.prototype.closest && (Element.prototype.closest = function (t) {
    ...
    function () {
        ...
        window.requestAnimationFrame || (window.requestAnimationFrame = function (e, n) {
            var i = (new Date).getTime(), o = Math.max(0, 16 - (i - t)), r = window.setTimeout(function () {
                e(i + o);
            }, o);
            return t = i + o, r;
    ...
    function (t, e) {
        ...
        return function (a, s) {
            ...
            h.animateScroll = function (i, a, s) {
                h.cancelScroll();
                var l = n(u || e, s || {}), m = "[object Number]" === Object.prototype.toString.call(i), p = m || !i.tagName ? null : i;
                if (m || p) {
                    var f = t.pageYOffset;
                    ...
                    var g, v, w, y, M, b, E, S, A = function (e) {
                        ...
                        var n;
                    }(d), T = m ? i : function (e, n, i, r) {
                        var a = 0;
                        if (e.offsetParent)
                            for (; a += e.offsetTop, e = e.offsetParent;)
                                ;
                        return a = Math.max(a - n - i, 0), r && (a = Math.min(a, o() - t.innerHeight)), a;
                    }(p, A, parseInt("function" == typeof l.offset ? l.offset(i, a) : l.offset, 10), l.clip), x = T - f, C = o(), L = 0, O = (g = x, w = (v = l).speedAsDuration ? v.speed : Math.abs(g / 1e3 * v.speed), v.durationMax && w > v.durationMax ? v.durationMax : v.durationMin && w < v.durationMin ? v.durationMin : parseInt(w, 10)), F = function (e) {
                        var n, o, s;
                        y || (y = e), L += e - y, b = f + x * (o = M = 1 < (M = 0 === O ? 0 : L / O) ? 1 : M, "easeInQuad" === (n = l).easing && (s = o * o), "easeOutQuad" === n.easing && (s = o * (2 - o)), "easeInOutQuad" === n.easing && (s = o < .5 ? 2 * o * o : (4 - 2 * o) * o - 1), "easeInCubic" === n.easing && (s = o * o * o), "easeOutCubic" === n.easing && (s = --o * o * o + 1), "easeInOutCubic" === n.easing && (s = o < .5 ? 4 * o * o * o : (o - 1) * (2 * o - 2) * (2 * o - 2) + 1), "easeInQuart" === n.easing && (s = o * o * o * o), "easeOutQuart" === n.easing && (s = 1 - --o * o * o * o), "easeInOutQuart" === n.easing && (s = o < .5 ? 8 * o * o * o * o : 1 - 8 * --o * o * o * o), "easeInQuint" === n.easing && (s = o * o * o * o * o), "easeOutQuint" === n.easing && (s = 1 + --o * o * o * o * o), "easeInOutQuint" === n.easing && (s = o < .5 ? 16 * o * o * o * o * o : 1 + 16 * --o * o * o * o * o), n.customEasing && (s = n.customEasing(o)), s || o), t.scrollTo(0, Math.floor(b)),
                            function (e, n) {
                                ...
                                if (e == n || d == n || (f < n && t.innerHeight + d) >= C)
                                    return h.cancelScroll(!0), s = n, u = m, 0 === (o = i) && document.body.focus(), u || (o.focus(), document.activeElement !== o && (o.setAttribute("tabindex", "-1"), o.focus(), o.style.outline = "none"), t.scrollTo(0, s)), r("scrollStop", l, i, a), !(c = y = null);
    ...
    function () {
        ...
        e = /^\(?([^)]*)\)?(?:(.)(d+))?$/, t = 2e3, n = 2, i = 1e3 / 30, p = document.createElement("div").style, a = null != p.transition || null != p.webkitTransition || null != p.mozTransition || null != p.oTransition, h = window.requestAnimationFrame || window.mozRequestAnimationFrame || window.webkitRequestAnimationFrame || window.msRequestAnimationFrame, o = window.MutationObserver || window.WebKitMutationObserver || window.MozMutationObserver, u = function (t) {
            ...
            if (!w && null != window.jQuery) {
                for (w = !0, o = [], e = 0, n = (i = ["html", "text"]).length; n > e; e++)
                    t = i[e], o.push(function (t) {
                        var e;
            ...
            function r(e) {
                ...
                for (o in this.el.odometer = this, c = r.options)
                    s = c[o], null == this.options[o] && (this.options[o] = s);
                ...
                try {
                    for (l = 0, d = (m = ["innerHTML", "innerText", "textContent"]).length; d > l; l++)
                        a = m[l], null != this.el[a] && function (t) {
            ...
            return r.prototype.renderInside = function () {
                ...
                if (!this.transitionEndBound) {
                    for (this.transitionEndBound = !0, e = !1, r = [], n = 0, i = (o = "transitionend webkitTransitionEnd oTransitionEnd otransitionend MSTransitionEnd".split(" ")).length; i > n; n++)
                        t = o[n], r.push(this.el.addEventListener(t, function () {
                ...
                var t, n, i, o, r, a, s, u;
                if ((t = null != (s = this.options.format) ? s : "(,ddd).dd") || (t = "d"), !(i = e.exec(t)))
                ...
                for (null == t && (t = this.value), this.stopWatchingMutations(), this.resetFormat(), this.inside.innerHTML = "", s = this.options.theme, r = [], d = 0, h = (e = this.el.className.split(" ")).length; h > d; d++)
                    (n = e[d]).length && ((o = /^odometer-theme-(.+)$/.exec(n)) ? s = o[1] : /^odometer(-|$)/.test(n) || r.push(n));
                for (r.push("odometer"), a || r.push("odometer-no-transitions"), r.push(s ? "odometer-theme-" + s : "odometer-auto-theme"), this.el.className = r.join(" "), this.ribbons = {}, this.digits = [], u = !this.format.precision || !l(t) || !1, c = 0, m = (p = t.toString().split("").reverse()).length; m > c; c++)
                    "." === (i = p[c]) && (u = !0), this.addDigit(i, u);
                ...
                if ("." === t)
                    return this.addSpacer(null != (r = this.format.radix) ? r : ".", null, "odometer-radix-mark");
                if (e)
                    for (o = !1;;) {
                ...
                if (n = +t - this.value)
                    return o = i = d(), e = this.value, (r = function () {
                        var s, u;
                ...
                var t, e, n, i, o, r;
                for (t = o = 0, r = (i = 1 <= arguments.length ? E.call(arguments, 0) : []).length; r > o; t = ++o)
                ...
                var t, e, n, i, o, r, a;
                for (e = /^\-?\d*\.(\d*?)0*$/, t = r = 0, a = (o = 1 <= arguments.length ? E.call(arguments, 0) : []).length; a > r; t = ++r)
                    i = o[t], o[t] = i.toString(), n = e.exec(o[t]), o[t] = null == n ? 0 : n[1].length;
                ...
                if (w = this.value, (l = this.getFractionalDigitCount(w, t)) && (t *= Math.pow(10, l), w *= Math.pow(10, l)), i = t - w) {
                    for (this.bindTransitionEnd(), o = this.getDigitCount(w, t), r = [], e = 0, h = b = 0; o >= 0 ? o > b : b > o; h = o >= 0 ? ++b : --b) {
                        if (y = g(w / Math.pow(10, o - h - 1)), a = (u = g(t / Math.pow(10, o - h - 1))) - y, Math.abs(a) > this.MAX_VALUES) {
                            for (c = [], m = a / (this.MAX_VALUES + this.MAX_VALUES * e * .5), n = y; a > 0 && u > n || 0 > a && n > u;)
                                c.push(Math.round(n)), n += m;
                        ...
                        for (h = E = 0, A = c.length; A > E; h = ++E)
                            d = c[h], c[h] = Math.abs(d % 10);
                        r.push(c);
                    }
                    for (this.resetDigits(), h = S = 0, T = (L = r.reverse()).length; T > S; h = ++S)
                        for (c = L[h], this.digits[h] || this.addDigit(" ", h >= l), null == (M = this.ribbons)[h] && (M[h] = this.digits[h].querySelector(".odometer-ribbon-inner")), this.ribbons[h].innerHTML = "", 0 > i && (c = c.reverse()), p = C = 0, x = c.length; x > C; p = ++C)
                            d = c[p], (v = document.createElement("div")).className = "odometer-value", v.innerHTML = d, this.ribbons[h].appendChild(v), p === c.length - 1 && s(v, "odometer-last-value"), 0 === p && s(v, "odometer-first-value");
            ...
            if (null != document.querySelectorAll) {
                for (a = [], n = 0, i = (e = document.querySelectorAll(r.options.selector || ".odometer")).length; i > n; n++)
                    t = e[n], a.push(t.odometer = new r({
                        el: t,
                ...
                function () {
                    this._events = {
                        ...
                        clickOverlay: function (t) {
                            var o = this.modal.offsetWidth - this.modal.clientWidth, e = t.clientX >= this.modal.offsetWidth - 15, s = this.modal.scrollHeight !== this.modal.offsetHeight;
